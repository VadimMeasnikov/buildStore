...
export default function Catalog({ arrCardsState, arrBasket }) {
  ...
  function nextCardPaint() {
    if (countPaint === allArrCards.paint.length - 1) {
      setCountPaint(0);
      return;
    }
  ...
  function prevCardPaint() {
    if (countPaint === 0) {
      setCountPaint(allArrCards.paint.length - 1);
      return;
    }
    setCountPaint((prevCountPaint) => prevCountPaint - 1);
  }
  ...
  function nextCardClothes() {
    if (countClothes === allArrCards.clothes.length - 1) {
      setCountClothes(0);
      return;
    }
  ...
  function prevCardClothes() {
    if (countClothes === 0) {
      setCountClothes(allArrCards.clothes.length - 1);
      return;
    }
    setCountClothes((prevCountClothes) => prevCountClothes - 1);
  }
  ...
  function nextCardSeason() {
    if (countSeason === allArrCards.seasonTools.length - 1) {
      setCountSeason(0);
      return;
    }
  ...
  function prevCardSeason() {
    if (countSeason === 0) {
      setCountSeason(allArrCards.seasonTools.length - 1);
      return;
    }
    setCountSeason((prevCountSeason) => prevCountSeason - 1);
  }
  ...
  function nextCardElectro() {
    if (countElectro === allArrCards.electro.length - 1) {
      setCountElectro(0);
      return;
    }
  ...
  function prevCardElectro() {
    if (countElectro === 0) {
      setCountElectro(allArrCards.electro.length - 1);
      return;
    }
    setCountElectro((prevCountElectro) => prevCountElectro - 1);
  }
  ...
  function nextCardForHouse() {
    if (countForHouse === allArrCards.forHouse.length - 1) {
      setCountForHouse(0);
      return;
    }
  ...
  function prevCardForHouse() {
    if (countForHouse === 0) {
      setCountForHouse(allArrCards.forHouse.length - 1);
      return;
    }
    setCountForHouse((prevCountForHouse) => prevCountForHouse - 1);
  }
  ...
  function nextCardTool() {
    if (countTool === allArrCards.tool.length - 1) {
      setCountTool(0);
      return;
    }
  ...
  function prevCardTool() {
    if (countTool === 0) {
      setCountTool(allArrCards.tool.length - 1);
      return;
    }
    setCountTool((prevCountTool) => prevCountTool - 1);
  }
        ...
        <div className="catalog-content1">
          <div className="paintBox productBox">
            <div className="titleBox">
              ...
              <div className="sliderButtons">
                <button onClick={prevCardPaint} className="sliderButton">
                  <img className="sliderButtonImg" src={prev} alt="" />
                </button>
                <button onClick={nextCardPaint} className="sliderButton">
                  <img className="sliderButtonImg" src={next} alt="" />
                </button>
              </div>
            </div>
            <div className="contentBox">
              <Card
                img={paintImgs[countPaint]}
                title={allArrCards.paint[countPaint].название}
                size={allArrCards.paint[countPaint].размер}
                type={allArrCards.paint[countPaint].тип}
                price={allArrCards.paint[countPaint].цена}
              />
          ...
          <div className="clothesBox productBox">
            <div className="titleBox">
              ...
              <div className="sliderButtons">
                <button onClick={nextCardClothes} className="sliderButton">
                  <img className="sliderButtonImg" src={prev} alt="" />
                </button>
                <button onClick={prevCardClothes} className="sliderButton">
                  <img className="sliderButtonImg" src={next} alt="" />
                </button>
              </div>
            </div>
            <div className="contentBox">
              <Card
                img={clothesImgs[countClothes]}
                title={allArrCards.clothes[countClothes].название}
                size={allArrCards.clothes[countClothes].размер}
                type={allArrCards.clothes[countClothes].тип}
                price={allArrCards.clothes[countClothes].цена}
              />
            </div>
          </div>
          ...
          <div className="seasonBox productBox">
            <div className="titleBox">
              ...
              <div className="sliderButtons">
                <button onClick={prevCardSeason} className="sliderButton">
                  <img className="sliderButtonImg" src={prev} alt="" />
                </button>
                <button onClick={nextCardSeason} className="sliderButton">
                  <img className="sliderButtonImg" src={next} alt="" />
                </button>
              </div>
            </div>
            <div className="contentBox">
              <Card
                img={seasonImgs[countSeason]}
                title={allArrCards.seasonTools[countSeason].название}
                material={allArrCards.seasonTools[countSeason].материал}
                type={allArrCards.seasonTools[countSeason].тип}
                price={allArrCards.seasonTools[countSeason].цена}
              />
            </div>
          </div>
        </div>
        <div className="catalog-content2">
          <div className="productBox">
            <div className="titleBox">
              ...
              <div className="sliderButtons">
                <button onClick={prevCardElectro} className="sliderButton">
                  <img className="sliderButtonImg" src={prev} alt="" />
                </button>
                <button onClick={nextCardElectro} className="sliderButton">
                  <img className="sliderButtonImg" src={next} alt="" />
                </button>
              </div>
            </div>
            ...
            <div className="contentBox">
              <Card
                img={electroImgs[countElectro]}
                title={allArrCards.electro[countElectro].название}
                power={allArrCards.electro[countElectro].мощность}
                type={allArrCards.electro[countClothes].тип}
                price={allArrCards.electro[countElectro].цена}
              />
            </div>
          </div>
          <div className="productBox">
            <div className="titleBox">
              ...
              <div className="sliderButtons">
                <button onClick={prevCardForHouse} className="sliderButton">
                  <img className="sliderButtonImg" src={prev} alt="" />
                </button>
                <button onClick={nextCardForHouse} className="sliderButton">
                  <img className="sliderButtonImg" src={next} alt="" />
                </button>
              </div>
            </div>
            <div className="contentBox">
              <Card
                img={forHouseImgs[countForHouse]}
                title={allArrCards.forHouse[countForHouse].название}
                type={allArrCards.forHouse[countForHouse].тип}
                size={allArrCards.forHouse[countForHouse].размер}
                price={allArrCards.forHouse[countForHouse].цена}
              />
            </div>
          </div>
          <div className="productBox">
            <div className="titleBox">
              ...
              <div className="sliderButtons">
                <button onClick={prevCardTool} className="sliderButton">
                  <img className="sliderButtonImg" src={prev} alt="" />
                </button>
                <button onClick={nextCardTool} className="sliderButton">
                  <img className="sliderButtonImg" src={next} alt="" />
                </button>
              </div>
            </div>
            <div className="contentBox">
              <Card
                img={toolImgs[countTool]}
                title={allArrCards.tool[countTool].название}
                material={allArrCards.tool[countTool].материал}
                type={allArrCards.tool[countTool].тип}
                price={allArrCards.tool[countTool].цена}
              />
            </div>
          </div>
        </div>
